  ...
  */
  ...
  return (
    <div className="container px-6 mx-auto grid">
      ...
      <hr />
      <div className="grid gap-10 mb-8 md:grid-cols-1 mt-5 dark:text-white">
        {/* Left Bar */}
        <div>
           ...
           {/*  <div className="mt-8">
            ...
            <div className="mt-5">
              <label className="block text-sm">
                ...
                <form onSubmit={hadnleSubmit} className="flex items-center space-x-2 mt-3">
